...
namespace HarryPotterAR
{
    ...
    public class HR_ManoEvent : MonoBehaviour
    {
        #region Singleton
        private static HR_ManoEvent _instance;
        public static HR_ManoEvent Instance
        {
            get
            {
                return _instance;
        ...
        {
            switch (HR_ManoManager.Instance.Manomotion_Session.flag)
            {
