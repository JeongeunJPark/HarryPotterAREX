...
namespace HarryPotterAR
{
    ...
    public class HR_ManoVisual : MonoBehaviour
    {
        #region variables
        ...
        private HR_ManoUtils mano_utils;
        ...
        void Start()
        {
            ...
            mano_utils = HR_ManoUtils.Instance;
        ...
        void Update()
        {
            ...
            for (int handIndex = 0; handIndex < handsSupportedByLicence; handIndex++)
            {
                ...
                handsSupportedByLicence = HR_ManoManager.Instance.Manomotion_Session.is_two_hands_enabled_by_developer + 1;
                ShowFingerTips(HR_ManoManager.Instance.Hand_infos[handIndex].hand_info.tracking_info, handIndex);
                ShowFingerTipLabels(HR_ManoManager.Instance.Hand_infos[handIndex].hand_info.tracking_info, handIndex);
                ShowPalmCenter(HR_ManoManager.Instance.Hand_infos[handIndex].hand_info.tracking_info, handIndex);
                ShowContour(HR_ManoManager.Instance.Hand_infos[handIndex].hand_info.tracking_info, handIndex);
                ShowInnerPoints(HR_ManoManager.Instance.Hand_infos[handIndex].hand_info.tracking_info, handIndex);
                UpdateLineColor(HR_ManoManager.Instance.Hand_infos[handIndex].hand_info.gesture_info, handIndex);
                UpdatePalmColor(HR_ManoManager.Instance.Hand_infos[handIndex].hand_info.gesture_info, handIndex);
                ShowLayering(HR_ManoManager.Instance.Hand_infos[handIndex], _layer_hands[handIndex], HR_ManoManager.Instance);
                ShowBoundingBoxInfo(HR_ManoManager.Instance.Hand_infos[handIndex].hand_info.tracking_info, handIndex);
            }
            if (_layer_background)
            {
                ShowBackground(HR_ManoManager.Instance.Visualization_info.rgb_image, _layer_background);
            }
        ...
        void ShowPalmCenter(TrackingInfo tracking_info, int index)
        {
            ...
            if (_show_palm_center)
            {
                ...
                HR_ManoUtils.Instance.CalculateNewPosition(palm_cent, depth);
        ...
        private void ShowBoundingBoxInfo(TrackingInfo tracking_info, int index)
        {
            ...
            bounding_box_ui[index].gameObject.SetActive(Show_bounding_box && HR_ManoManager.Instance.Hand_infos[0].hand_info.warning != Warning.WARNING_HAND_NOT_FOUND);
        ...
        {
            fingertip_parent.SetActive(_show_fingertips && HR_ManoManager.Instance.Hand_infos[0].hand_info.warning != Warning.WARNING_HAND_NOT_FOUND);
            if (_show_fingertips)
            {
                for (int i = 0; i < 5; i++)
                {
        ...
        {
            fingertip_label_parent.SetActive(_show_fingertip_labels && HR_ManoManager.Instance.Hand_infos[0].hand_info.warning != Warning.WARNING_HAND_NOT_FOUND);
        ...
        private void ShowContour(TrackingInfo tracking_info, int index)
        {
            ...
            contour_parent.SetActive(Show_contour && HR_ManoManager.Instance.Hand_infos[0].hand_info.warning != Warning.WARNING_HAND_NOT_FOUND);
        ...
        {
            inner_parent.SetActive(_show_inner && HR_ManoManager.Instance.Hand_infos[0].hand_info.warning != Warning.WARNING_HAND_NOT_FOUND);
            if (_show_inner)
            {
        ...
        void ShowLayering(HandInfoUnity hand_info, MeshRenderer layer_hands, HR_ManoManager mano_manager)
        {
            ...
            if (_show_hand_layer)
            {
                ...
                HR_ManoUtils.Instance.OrientMeshRenderer(layer_hands);
                ...
                mano_utils.AjustBorders(layer_hands, HR_ManoManager.Instance.Manomotion_Session);
            }
        }
        ...
        void ShowBackground(Texture2D backgroundTexture, MeshRenderer backgroundMeshRenderer)
        {
            ...
            if (Show_background_layer)
            {
                ...
                HR_ManoUtils.Instance.OrientMeshRenderer(backgroundMeshRenderer);
                //content
                backgroundMeshRenderer.material.mainTexture = backgroundTexture;
                //Adjust the size in order to fit the screen
                mano_utils.AjustBorders(backgroundMeshRenderer, HR_ManoManager.Instance.Manomotion_Session);
            }
        ...
        //{
        //    if (HR_ManoManager.Instance.Manomotion_Session.is_two_hands_enabled_by_developer == 1)
        //    {
        //        HR_ManoManager.Instance.Set2HandSupport(0);
        //        manomotionUI.ShowHandButtons();
        //    }
        //    else if (HR_ManoManager.Instance.Manomotion_Session.is_two_hands_enabled_by_developer == 0)
        //    {
        //        HR_ManoManager.Instance.Set2HandSupport(1);
