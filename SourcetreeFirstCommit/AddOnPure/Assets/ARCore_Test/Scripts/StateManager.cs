...
public class StateManager : MonoBehaviour
{
    ...
    protected SceneState state = SceneState.None;
    ...
    void Update()
    {
        ...
        switch(state)
        {
            case SceneState.FindSurface:
                FindSurface();
                break;
            case SceneState.AttachObject:
                AttachObject();
                break;
            case SceneState.PlayAnimation:
                PlayAnimation();
                break;
        }
    }
    ...
    protected void AttachObject()
    {
        ...
        state = SceneState.PlayAnimation;
    }
